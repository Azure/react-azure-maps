  ...
  (function(t) {
    ...
    i.extend(m.prototype, a, {
      ...
      destroy: function(t) {
        ...
        return (
          this.isNew() ? i.defer(t.success) : (G(this, t), (a = this.sync('delete', this, t))),
          r || s(),
          a
        )
      },
      ...
      (e.stemmer = (function() {
        var e = {
          ...
          I = function(r) {
            ...
            ;(o = S).test(r) &&
              ((i = (I = o.exec(r))[1]), (n = I[2]), (o = c).test(i) && (r = i + e[n]))
            ;(o = E).test(r) &&
              ((i = (I = o.exec(r))[1]), (n = I[2]), (o = c).test(i) && (r = i + t[n]))
      ...
      (e.QueryLexer.lexText = function(t) {
        for (;;) {
          ...
          if (92 != r.charCodeAt(0)) {
            ...
            if ('~' == r)
              return (
                t.backup(), 0 < t.width() && t.emit(e.QueryLexer.TERM), e.QueryLexer.lexEditDistance
              )
            if ('^' == r)
